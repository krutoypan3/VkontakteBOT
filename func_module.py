...
try:
    ...
    def get_session(host):
        ...
        session.headers = {
            ...
            'cookie': 'device_view=full; REMEMBERME=VU5cVXNlckJ1bmRsAXxFbnRpdHlcVXNlcjpZVzl0TVRNPToxNjMzNzQ0NzUzOmZmMThhNGU3Mjk4OTgyZDcwNWU4OWYxNzdmMzRlYzViYzNmZWE2MjY5ZWM2MjY5YmUyYzgzYzU5YWQzOGZlNDk%3D',  # ВАЖНО Я ХЗ НАСЧЕТ СТАБИЛЬНОЙ РАБОТЫ
